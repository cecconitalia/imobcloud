...
// REMOVIDO: CalendarView foi substituída pelo componente mais dinâmico
// import CalendarView from '@/views/CalendarView.vue'
// IMPORTAÇÕES DAS NOVAS VIEWS
import RelatoriosView from '@/views/RelatoriosView.vue'
import AutorizacoesView from '@/views/AutorizacoesView.vue'
// ADICIONADO: Importação do novo componente de calendário
...
                    }
                },
                // ADICIONADO/ALTERADO: Rota para o novo calendário de tarefas dinâmico
                {
                    path: 'calendario',
                    name: 'calendario',
                    component: CalendarioTarefas, // Alterado para o novo componente
                    meta: {
