...
class Cliente(models.Model):
    ...
    cpf_cnpj = models.CharField(max_length=18, unique=False, verbose_name="CPF/CNPJ") # Mudei para False, pois pode não ser único globalmente
    ...
    class Meta:
        ...
        # Adicionando unique_together para garantir que CPF/CNPJ seja único POR imobiliária
